          ...
          <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
            <nav className="navbar8-links1">
              ...
              <a href={props.link2Url} className="thq-link thq-body-small">
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text16">#community-history</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                <span className="thq-link thq-body-small">
                  {props.link4 ?? (
                    <Fragment>
                      <span className="navbar8-text21">#discussion-forum</span>
                    </Fragment>
                  )}
                </span>
            ...
            <div className="navbar8-buttons1">
              ...
              <button className="navbar8-action21 thq-button-outline thq-button-animated">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text27">Start a Discussion</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Navbar8.defaultProps = {
  ...
  logoAlt: 'Diaspora Community Logo',
  link1Url: '/',
  link2Url: '/history',
  link3Url: '/events',
  link4Url: '/forum',
  action1: <span className="navbar8-text">Join Now</span>,
  action2: <span className="navbar8-text">Start Discussion</span>,
}
