              ...
              <p className="pricing14-text102 thq-body-large">
                  ...
                  <Fragment>
                    <span className="pricing14-text202">
                      Whether you’re here to stay informed, support our cultural events, or
                      actively give back, choose the plan that fits your level of involvement:
                      Free Members get full access to news and forums; Supporters enjoy early
                      event registration and exclusive updates; Sponsors receive organizational
                      recognition and dedicated perks.
                    <span
                ...
                <div className="pricing14-price10">
                  <div className="pricing14-price11">
                    ...
                    <h3 className="pricing14-text108 thq-heading-3">
                      {props.plan1Price ?? (
                        <Fragment>
                          <span className="pricing14-text204">$20/mo</span>
                        </Fragment>
                      )}
                    </h3>
